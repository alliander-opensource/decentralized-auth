const config = {
  ...
  // Our 'Raspberry Pi' device, same settings as defaults on front-end
  deviceSeed: 'YDHRCDSMPRIYLGJDKKQFWUIBLIRTUIBCATSINVMHYLLIQYMKRYEQHU9PJYGGNLXQMUXCQQUEGHHUHAAGO',
  deviceSecret: 'APPLE',
  deviceInitialSideKey: 'BANANA',
